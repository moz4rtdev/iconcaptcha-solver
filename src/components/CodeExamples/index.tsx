...
const solve = async () => {
  const response = await axios.post('https://iconcaptcha-solver.vercel.app/api/v1/solve', {
    token: 'YOUR_TOKEN',
    image: 'BASE64_IMG'
  });
...
response = requests.post(
    'https://iconcaptcha-solver.vercel.app/api/v1/solve',
    json={
        'token': 'YOUR_TOKEN',
        'image': 'BASE64_IMG'
    }
...
$ch = curl_init('https://iconcaptcha-solver.vercel.app/api/v1/solve');
...
public class IconCaptchaSolver {
    public static void main(String[] args) throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder()
            .uri(URI.create("https://iconcaptcha-solver.vercel.app/api/v1/solve"))
    ...
    curl: {
        ...
        code: `curl -X POST https://iconcaptcha-solver.vercel.app/api/v1/solve \\
