      ...
      <header className="relative w-full py-8 px-4 bg-black/40 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav>
            <Link
              href="/token"
              className="flex items-center gap-2 text-gray-300 hover:text-white transition-colors px-4 py-2 rounded-lg bg-gradient-to-r from-blue-500/20 to-purple-500/20 hover:from-blue-500/30 hover:to-purple-500/30 backdrop-blur-sm"
            >
      ...
      <main className="relative max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Experience the power of our advanced AI technology that automatically solves
            IconCaptcha challenges with remarkable accuracy.
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 shadow-xl hover:border-white/20 transition-colors">
              ...
              <p className="text-gray-300 leading-relaxed">
                Our advanced AI model analyzes the IconCaptcha pattern and identifies the correct icon position with exceptional accuracy, providing instant results.
              </p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2 bg-gradient-to-r from-blue-400/10 to-purple-400/10 rounded-xl p-4 border border-blue-400/20">
                  ...
                  <p className="text-sm text-gray-300">
                    Average response time under 1 second with our optimized AI model
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 className="font-semibold text-white">High Accuracy</h5>
                        <p className="text-xs text-gray-400">99.9% success rate</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Simple integration</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 className="font-semibold text-white">Theme Support</h5>
