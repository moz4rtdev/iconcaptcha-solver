...
export default function TokenPage() {
  ...
  const addCredits = async () => {
    try {
      ...
      setError(
        err.message ||
          "Failed to add credits. Please check your token and try again.",
      );
    } finally {
      setLoading(false);
    }
              ...
              {!token && !showAd && (
                <div className="space-y-6">
                  ...
                  <button
                    ...
                    disabled={
                      loading || (mode === "generate" ? !email : !existingToken)
                    }
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-gray-400 mb-6">
                      {mode === "generate"
                        ...
                        : "600 credits have been added to your token successfully."}
                    </p>
                  </div>
